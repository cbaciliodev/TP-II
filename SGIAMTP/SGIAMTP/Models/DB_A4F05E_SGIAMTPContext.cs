...
namespace SGIAMTP.Models
{
    public partial class DB_A4F05E_SGIAMTPContext : DbContext
    {
        ...
        public virtual DbSet<TMarinera> TMarinera { get; set; }
...
//#warning To protect potentially sensitive information in your connection string, you should move it out of source code. See http://go.microsoft.com/fwlink/?LinkId=723263 for guidance on storing connection strings.
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity<TMarinera>(entity =>
            {
                entity.HasKey(e => e.PkImCod);

                entity.ToTable("T_Marinera");

                entity.Property(e => e.PkImCod)
                    .HasColumnName("PK_IM_Cod")
                    .ValueGeneratedNever();

                entity.Property(e => e.VmNombre)
                    .HasColumnName("VM_Nombre")
                    .HasMaxLength(50)
                    .IsUnicode(false);
            });
